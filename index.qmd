...
<div class="container-fluid justify-content-evenly d-flex flex-row-reverse column-gap-5 column-page page-full">
<div>
<div id="blog">
</div>
<br>
...
<div class="d-flex justify-content-center column-page page-full my-2">
<button type="button" class="btn button--nav-down">
<i class="bi bi-chevron-down"></i>
</button>
</div>

<section id="key-facts" class="column-page page-full">
...
<div id="current-events" class="column-page mt-5 d-flex align-items-center text-center flex-column">

</div>

<div class="d-flex column-page page-full">
