...
listing:
  ...
  - id: upcoming-events
    template: templates/partials/upcoming-events-section.ejs
...
<section id="upcoming-events-wrapper">
<div id="upcoming-events">
</div>
</section>

<section id="interest" class="column-page page-full">
<h1 class="d-flex justify-content-center display-1 fw-bolder">One UCL based studentship still available.</h1> <br>
We have one additional studentship available for 2026 entry to work on numerical projects within the UCL Department of Mathematics. If you are interested, please apply below by 12 June 2026, 17:00 (GMT). **Please do not apply again if you have already applied earlier in this cycle.**
<div class="d-flex flex-column justify-content-center align-items-center row-gap-4">
<a href="./apply.html" type="button" class="btn btn-outline my-3" id="btn--signup">
<span class="display-6">Apply for 2026 entry into the CDT</span>
</a>
